...
import { Loader2, Plus, Trash2, Receipt, Wallet, FileText, TrendingDown } from "lucide-react";
...
export default function ExpensesPage() {
  ...
  return (
    <PageShell ambientColor="bg-rose-500/5">
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <PageHeader
          title="المصاريف التشغيلية"
          subtitle="إدارة وتقييد كافة النفقات اليومية والشهرية"
          icon={Wallet}
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <Card className="glass-panel border-rose-500/20 bg-rose-500/5 rounded-[40px] overflow-hidden p-8 flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="text-center md:text-right">
                  <p className="text-xs font-bold text-muted-foreground opacity-50 mb-2 italic">الرقابة المحاسبية</p>
